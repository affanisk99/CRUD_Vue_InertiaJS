        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                    ...
                    <button @click="openModal()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Create New Teacher</button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            save: function (data) {
                this.$inertia.post('/teachers', data)
                this.reset();
                this.closeModal();
                this.editMode = false;
            },
